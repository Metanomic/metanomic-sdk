...
import MetanomicClient, { MetanomicClientProps } from './client'
import { Asset } from './entities/asset'
import { Product } from './entities/product'

export { MetanomicClientProps } from './client'

/**
 * @summary The SDK client for the Metanomic.
 */
export default class Metanomic extends MetanomicClient {

  constructor(appId: string, apiKey: string, props?: MetanomicClientProps) {
    super(appId, apiKey, props)
  }
