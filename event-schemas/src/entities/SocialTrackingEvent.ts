import SocialTrackingEventType from './SocialTrackingEventType';
import EventSourceContextSchema from './EventSourceContextSchema';
import TheValuePayload from './TheValuePayload';
import Asset from './Asset';
import Product from './Product';

class SocialTrackingEvent {
  private _type: SocialTrackingEventType;
  ...
  get type(): SocialTrackingEventType { return this._type; }
  set type(type: SocialTrackingEventType) { this._type = type; }
...
export default SocialTrackingEvent;
