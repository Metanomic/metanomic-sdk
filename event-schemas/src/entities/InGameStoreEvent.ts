...
class InGameStoreEvent {
  ...
  get type(): InGameStoreEventType { return this._type; }
  set type(type: InGameStoreEventType) { this._type = type; }
...
export default InGameStoreEvent;
