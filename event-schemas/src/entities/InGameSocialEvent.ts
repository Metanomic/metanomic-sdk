import InGameSocialEventType from './InGameSocialEventType';
import EventSourceContextSchema from './EventSourceContextSchema';
import TheValuePayload from './TheValuePayload';
import Asset from './Asset';
import Product from './Product';

class InGameSocialEvent {
  private _type: InGameSocialEventType;
  ...
  get type(): InGameSocialEventType { return this._type; }
  set type(type: InGameSocialEventType) { this._type = type; }
...
export default InGameSocialEvent;
