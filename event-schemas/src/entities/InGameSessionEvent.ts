import InGameSessionEventType from './InGameSessionEventType';
import EventSourceContextSchema from './EventSourceContextSchema';
import TheValuePayload from './TheValuePayload';
import Asset from './Asset';
import Product from './Product';

class InGameSessionEvent {
  private _type: InGameSessionEventType;
  ...
  get type(): InGameSessionEventType { return this._type; }
  set type(type: InGameSessionEventType) { this._type = type; }
...
export default InGameSessionEvent;
