import CommerceEventType from './CommerceEventType';
...
class CommerceEvent {
  private _type: CommerceEventType;
  ...
  get type(): CommerceEventType { return this._type; }
  set type(type: CommerceEventType) { this._type = type; }
