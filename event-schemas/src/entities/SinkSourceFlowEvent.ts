...
class SinkSourceFlowEvent {
  ...
  get type(): SinkSourceEventType { return this._type; }
  set type(type: SinkSourceEventType) { this._type = type; }
...
export default SinkSourceFlowEvent;
