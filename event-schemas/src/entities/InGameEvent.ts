import InGameEventType from './InGameEventType';
...
class InGameEvent {
  ...
  get type(): InGameEventType { return this._type; }
  set type(type: InGameEventType) { this._type = type; }
