import MarketingEventType from './MarketingEventType';
...
class MarketingEvent {
  private _type: MarketingEventType;
  ...
  get type(): MarketingEventType { return this._type; }
  set type(type: MarketingEventType) { this._type = type; }
