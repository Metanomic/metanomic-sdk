import GenericProgressEventType from './GenericProgressEventType';
import EventSourceContextSchema from './EventSourceContextSchema';
import TheValuePayload from './TheValuePayload';
import Asset from './Asset';
import Product from './Product';

class GenericProgressEvent {
  private _type: GenericProgressEventType;
  ...
  get type(): GenericProgressEventType { return this._type; }
  set type(type: GenericProgressEventType) { this._type = type; }
...
export default GenericProgressEvent;
