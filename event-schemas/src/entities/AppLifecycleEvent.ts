import AppLifecycleEventType from './AppLifecycleEventType';
...
class AppLifecycleEvent {
  private _type: AppLifecycleEventType;
  ...
  get type(): AppLifecycleEventType { return this._type; }
  set type(type: AppLifecycleEventType) { this._type = type; }
...
export default AppLifecycleEvent;
