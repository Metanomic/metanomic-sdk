import IdentityEventType from './IdentityEventType';
...
class IdentityEvent {
  private _type: IdentityEventType;
  ...
  get type(): IdentityEventType { return this._type; }
  set type(type: IdentityEventType) { this._type = type; }
