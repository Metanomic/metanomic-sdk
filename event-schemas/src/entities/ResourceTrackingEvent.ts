import ResourceTrackingEventType from './ResourceTrackingEventType';
import EventSourceContextSchema from './EventSourceContextSchema';
import TheValuePayload from './TheValuePayload';
import Asset from './Asset';
import Product from './Product';

class ResourceTrackingEvent {
  private _type: ResourceTrackingEventType;
  ...
  get type(): ResourceTrackingEventType { return this._type; }
  set type(type: ResourceTrackingEventType) { this._type = type; }
...
export default ResourceTrackingEvent;
